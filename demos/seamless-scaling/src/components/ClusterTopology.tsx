...
export function ClusterTopology({
  ...
  const getZoneStyle = (zone: ZoneInfo) => {
    if (zone.isDeleting) {
      return {
        ...
        badge: "bg-red-500",
        badgeTextId: "topology.badge.deleting",
      };
    }
    if (zone.isOld) {
      return {
    ...
    if (zone.isNew) {
      return {
        ...
        badge: "bg-green-500",
        badgeTextId: "topology.badge.new",
      };
    }
    return {
  ...
  const totalObservers = zones.reduce(
    (sum, zone) => sum + zone.observerCount,
    0
  );

  return (
    <div
      className={`rounded-lg p-3 h-full flex flex-col border ${
        theme === "dark"
      ...
      <div className="flex-1 overflow-visible" style={{ minHeight: 0 }}>
        <div className="space-y-3">
          ...
          >
            ...
            <div
              className="overflow-x-auto mb-3 overflow-y-visible"
              style={{
                maxWidth: "100%",
                marginTop: "-4px",
                paddingTop: "8px",
                    ...
                    return (
                      ...
                      >
                        ...
                        {style.badge && (
                          ...
                          >
                            <FormattedMessage id={style.badgeTextId!} />
                          </motion.div>
                        )}
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            {Array.from({ length: zone.observerCount }).map(
                              (_, idx) => {
                                // 判断显示 Leader 还是 Follower
                                const replicaLabelId = zone.isPrimary
                                  ? "topology.replica.leaderFollower"
                                  : "topology.replica.follower";
                                  ...
                                  >
                                    <div className="flex items-center gap-2">
                                      ...
                                      <div className="flex-1">
                                        ...
                                        <div
                                          className={`text-xs ${style.subtext}`}
                                        >
                                          <FormattedMessage
                                            id={replicaLabelId}
                                          />
                          ...
                          <div className="mt-2 text-center">
                            ...
                            >
                              {zone.observerCount}
                              <FormattedMessage
                                id="topology.observer"
                                defaultMessage="台 OBServer"
                              />
                            </span>
                          </div>
              ...
              <div className="flex justify-center">
                ...
                >
                  ...
                  <div className="text-purple-400/70 text-xs">
                    <FormattedMessage
                      id="topology.arbitration"
                      defaultMessage="仲裁服务 (1A)"
                    />
                  </div>
                ...
                <FormattedMessage
                  id={
                    scalingDirection === "scale-out"
                      ? "topology.flow.scaleOut"
                      : "topology.flow.scaleIn"
                  }
                  defaultMessage={
                    ...
                    {scalingState === "scaling-out" && (
                      <>
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            <FormattedMessage
                              id="topology.flow.step1.syncing"
                              defaultMessage="步骤1：添加新 Zone 后，开始同步副本"
                            />
                          </span>
                        </div>
                        <div className="flex items-center gap-2 text-slate-500">
                          ...
                          <span>
                            <FormattedMessage
                              id="topology.flow.step2.switching"
                              defaultMessage="步骤2：副本同步完成，切换主可用区"
                            />
                          </span>
                        </div>
                        <div className="flex items-center gap-2 text-slate-500">
                          ...
                          <span>
                            <FormattedMessage
                              id="topology.flow.step3.scaleOut.deleting"
                              defaultMessage="步骤3：删除旧 Zone，完成每个 Zone 的 OBServer 数从 2 -> 4 的扩容"
                            />
                          </span>
                        </div>
                      </>
                    ...
                    {scalingState === "completed" && (
                      <>
                        ...
                        <div className="flex items-center gap-2 text-green-400">
                          ...
                          <span>
                            <FormattedMessage
                              id="topology.flow.step3.scaleOut.done"
                              defaultMessage="步骤3：删除旧 Zone，完成每个 Zone 的 OBServer 数从 2 -> 4 的扩容 ✓"
                            />
                          </span>
                        </div>
                    ...
                    {scalingState === "scaling-in" && (
                      <>
                        ...
                        <div className="flex items-center gap-2 text-slate-500">
                          ...
                          <span>
                            <FormattedMessage
                              id="topology.flow.step3.scaleIn.deleting"
                              defaultMessage="步骤3：删除旧 Zone，完成每个 Zone 的 OBServer 数从 4 -> 2 的缩容"
                            />
                          </span>
                        </div>
                      </>
                    ...
                    {scalingState === "completed" && (
                      <>
                        ...
                        <div className="flex items-center gap-2 text-green-400">
                          ...
                          <span>
                            <FormattedMessage
                              id="topology.flow.step3.scaleIn.done"
                              defaultMessage="步骤3：删除旧 Zone，完成每个 Zone 的 OBServer 数从 4 -> 2 的缩容 ✓"
                            />
                          </span>
                        </div>
